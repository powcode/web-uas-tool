...
<body>
    <div class="detail-container">
        ...
        <p><strong>Kategori:</strong> <?= htmlspecialchars($game['nama_kategori']) ?></p>
        <p><strong>Deskripsi:</strong> <?= nl2br(htmlspecialchars($game['deskripsi'])) ?></p>
        <p><strong>Spesifikasi:</strong><br><?= nl2br(htmlspecialchars($game['spesifikasi'])) ?></p>
