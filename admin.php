...
if (isset($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        ...
        $error = "Gagal menghapus game. Silahkan coba lagi.";
    }
}
...
<body>
    <div class="form-container">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            <thead>
                <tr>
                    ...
                    <th style="border-bottom: 1px solid #fff; padding: 10px;">Judul</th>
                    <th style="border-bottom: 1px solid #fff; padding: 10px;">Kategori</th>
                    <th style="border-bottom: 1px solid #fff; padding: 10px;">Aksi</th>
                </tr>
            </thead>
            <tbody>
        ...
        <a href="add_game.php" class="form-button">Tambah</a>
    </div>
</body>
</html>
